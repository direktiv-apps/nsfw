...
//go:generate swagger generate server --target ../../app --name Nsfw --spec ../../../swagger.yaml --template-dir /home/jensg/go/src/github.com/direktiv-apps/nsfw/build/templates --principal interface{}

func configureFlags(api *operations.NsfwAPI) {
...
func configureAPI(api *operations.NsfwAPI) http.Handler {
